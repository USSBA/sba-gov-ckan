...
ALTER USER datastore_ro WITH PASSWORD 'datastore';
...
-- GRANT CREATE ON SCHEMA public TO "ckan"; db "ckan" doesn't exist
-- GRANT USAGE ON SCHEMA public TO "ckan"; db "ckan" doesn't exist

GRANT CREATE ON SCHEMA public TO "datastore";
GRANT USAGE ON SCHEMA public TO "datastore";

-- take connect permissions from main db
-- REVOKE CONNECT ON DATABASE "ckan" FROM "datastore_ro"; db "ckan" doesn't exist
...
ALTER VIEW "_table_metadata" OWNER TO "datastore";
...
ALTER FUNCTION populate_full_text_trigger() OWNER TO "datastore";
